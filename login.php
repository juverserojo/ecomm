...
<form method="POST" action="login.php" class="signin-form" autocomplete="off">
...
<div class="form-group">
<button type="submit" class="form-control btn btn-primary rounded submit px-3" value="Login">Login</button>
</div>
...
<a href=""  onclick="yare()">Forgot Password</a>
</div>
</div>
</form>
