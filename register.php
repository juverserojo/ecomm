...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_username_result->num_rows > 0) {
        ...
        $insert_sql = "INSERT INTO users (firstname, lastname, username, password) VALUES ('$firstname', '$lastname', '$username', '$password')";
...
<!-- Mirrored from preview.colorlib.com/theme/bootstrap/login-form-15/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 May 2024 11:40:23 GMT -->
<head>
<title>Sign Up Shopping</title>
<meta charset="utf-8">
...
.custom-file-input {
  ...
  .custom-file-input:lang(en) ~ .custom-file-label::after {
    content: "Browe"; }
  .custom-file-input ~ .custom-file-label[data-browe]::after {
    content: attr(data-browe); }
...
/* Hide the brower's default checkbox */
.checkbox-wrap input {
  position: absolute;
  opacity: 0;
  cursor: pointer;
...
<form method="POST" action="register.php" class="signin-form" autocomplete="off">
...
<div class="form-group">
<button type="submit" class="form-control btn btn-primary rounded submit px-3" onclick="" value="Register">Register Now!</button>
</div>

<div class="form-group d-md-flex">
<div class="w-50 text-left">
<!-- <label class="checkbox-wrap checkbox-primary mb-0">Show Password
<input type="checkbox" id="passwordDisplay" checked>
<span class="checkmark"id="passwordDisplay"></span> -->
